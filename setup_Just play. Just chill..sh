...
# Параметры
BUNDLE_ID="com.juschill.bjaf"
APPLE_ID="6747888372"
REMOTE_URL="git@github.com:sdeslvm/Just-play.-Just-chill..git"
PROJECT_NAME="Just play. Just chill."
SCHEME_NAME="Just play. Just chill."
