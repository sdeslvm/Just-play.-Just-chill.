...
protocol JustPlayWebStatusComparable {
...
enum JustPlayWebStatus: Equatable, JustPlayWebStatusComparable {
    case standby
    ...
    func isEquivalent(to other: JustPlayWebStatus) -> Bool {
        switch (self, other) {
...
extension JustPlayWebStatus {
    static func == (lhs: JustPlayWebStatus, rhs: JustPlayWebStatus) -> Bool {
